...
export default function Page() {
  return (
    ...
    >
      <div>
        <h2 className="text-3xl font-heading font-bold text-secondary">Inventory / Availability</h2>
        <p className="text-muted-foreground mt-1">Manage and view details for inventory / availability.</p>
      </div>

      <Card className="border-0 shadow-sm ring-1 ring-slate-100 rounded-2xl">
        <CardHeader className="bg-slate-50/50 border-b border-slate-100 pb-6">
          <CardTitle className="font-heading">Inventory / Availability Configuration</CardTitle>
        ...
        <CardContent className="p-8 flex items-center justify-center min-h-[300px]">
          <div className="text-center space-y-3">
            ...
            <p className="text-sm text-slate-500 max-w-sm mx-auto">
              We are working on integrating the necessary APIs and components for the Inventory / Availability page.
            </p>
          </div>
        </CardContent>
      </Card>
